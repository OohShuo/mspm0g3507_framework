...
static const Buzzer_note sfx_pacman_waka[] = {
    S(E5, 36),
    S(G5, 44),
};
...
static const Buzzer_note sfx_snake_turn[] = {
    S(C6, 30),
    G(C6, 25),
};
static const Buzzer_note sfx_snake_grow[] = {
    S(C6, 35),
    S(E6, 40),
    S(G6, 50),
};
...
static const Buzzer_note sfx_racing_crash[] = {
    V(C5, 55, 90),
    G(G4, 80),
    L(C4, 140),
};
...
static const Buzzer_note sfx_air_hit[] = {
    V(A5, 35, 80),
    G(E5, 50),
    S(C5, 60),
};
...
/* ── Tetris ── */
static const Buzzer_note sfx_tetris_move[] = {
    V(C7, 12, 40),
    S(E7, 16),
};
static const Buzzer_note sfx_tetris_rotate[] = {
    S(E7, 18),
    S(C7, 22),
};
static const Buzzer_note sfx_tetris_lock[] = {
    V(G5, 40, 55),
    S(C5, 60),
};
static const Buzzer_note sfx_tetris_line_clear[] = {
    S(B5, 40),
    S(E6, 45),
    S(G6, 55),
    N(B6, 75),
...
/* ── Breakout ── */
static const Buzzer_note sfx_breakout_bounce[] = {
    S(A6, 20),
    S(C7, 28),
};
static const Buzzer_note sfx_breakout_brick[] = {
    S(G6, 35),
    S(C7, 45),
    S(E7, 30),
};
...
/* ── Pong ── */
static const Buzzer_note sfx_pong_paddle[] = {
    V(E7, 18, 35),
};
static const Buzzer_note sfx_pong_wall[] = {
    V(A6, 22, 40),
};
static const Buzzer_note sfx_pong_score[] = {
    G(E7, 50),
    G(C7, 65),
};

/* ── Gomoku ── */
static const Buzzer_note sfx_gomoku_place[] = {
    S(C6, 40),
    S(G5, 55),
    N(E5, 70),
};
...
/* ── 2048 ── */
static const Buzzer_note sfx_slide[] = {
    S(C6, 30),
    G(C6, 40),
};
static const Buzzer_note sfx_merge[] = {
    S(C6, 35),
    S(E6, 40),
    N(G6, 60),
};
...
/* ── Dino Runner ── */
static const Buzzer_note sfx_dino_jump[] = {
    S(C6, 30),
    N(E6, 50),
};
static const Buzzer_note sfx_dino_duck[] = {
    G(E6, 35),
    S(C5, 48),
};

/* ── Flappy Bird ── */
static const Buzzer_note sfx_flappy_flap[] = {
    S(C6, 28),
    S(E6, 36),
};
static const Buzzer_note sfx_flappy_score[] = {
    S(C6, 38),
    S(E6, 42),
    N(G6, 70),
};
...
/* ── Maze ── */
static const Buzzer_note sfx_maze_move[] = {
    V(C7, 12, 30),
};
static const Buzzer_note sfx_maze_goal[] = {
    S(C6, 60),
    S(E6, 65),
    S(G6, 75),
    N(C7, 110),
...
/* ── Needle ── */
static const Buzzer_note sfx_needle_launch[] = {
    G(C5, 50),
    G(E5, 55),
    N(G5, 40),
};
static const Buzzer_note sfx_needle_stick[] = {
    V(C7, 20, 50),
    S(G6, 35),
};
