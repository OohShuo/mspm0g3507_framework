...
/* Run the bit-bang hot path from RAM to avoid flash wait states (~2-3 WS at
 * 32 MHz on MSPM0G3507).  On Cortex-M0+ this makes the tight inner loop
 * run at full 1-cycle-per-instruction speed instead of stalling on flash. */
