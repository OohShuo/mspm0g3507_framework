...
void W25q32_Read(W25q32* o, uint32_t a, uint8_t* d, uint32_t l) {
    (void)o;
    (void)a;
    if (d) memset(d, 0xFF, l);
}
void W25q32_Page_Program(W25q32* o, uint32_t a, const uint8_t* d, uint32_t l) {
    (void)o;
    (void)a;
    (void)d;
    (void)l;
}
void W25q32_Sector_Erase(W25q32* o, uint32_t a) {
    (void)o;
    (void)a;
}
void W25q32_Block_Erase_32K(W25q32* o, uint32_t a) {
    (void)o;
    (void)a;
}
void W25q32_Block_Erase_64K(W25q32* o, uint32_t a) {
    (void)o;
    (void)a;
}
